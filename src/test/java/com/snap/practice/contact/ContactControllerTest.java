...
public class ContactControllerTest {
    ...
    public void init() {
        ...
        contactController.addNewContact(samanContactDTO);
        contactController.addNewContact(armanContactDTO);
    }
    ...
    public void searchForSamanContactByName() {
        ...
        List<ContactDTO> result = contactController.searchContact(samanSearchDTO);
    ...
    public void searchForArmanContactByEmail() {
        ...
        List<ContactDTO> result = contactController.searchContact(armanSearchDTO);
    ...
    public void searchAllContactByEmptyArguments() {
        ...
        List<ContactDTO> result = contactController.searchContact(searchDTO);
        Assertions.assertTrue(result.contains(samanContactDTO));
        Assertions.assertTrue(result.contains(armanContactDTO));
    }
}
